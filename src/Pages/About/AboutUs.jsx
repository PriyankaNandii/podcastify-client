...
const AboutUs = () => {
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md">
      ...
      <header class="bg-[#171717] dark:bg-gray-900">
        <div class="container px-5 md:px-20 py-16 mx-auto">
          <div class="items-center lg:flex">
            <div class="w-full lg:w-1/2">
              <div class="lg:max-w-lg">
                <h1 class="text-3xl font-semibold text-white dark:text-white lg:text-5xl">
				Welcome to Our {" "}
                  <span class="text-red-800 mt-2 ">Podcastify</span>
                </h1>

                <p class="mt-3 text-[#dededecc] dark:text-gray-400 mb-5">
				Your go-to destination for fresh beats, artist insights, and all things music. Join us and vibe with the rhythm!
                </p>
            ...
            <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
              <img
                class="w-full h-full lg:max-w-lg rounded-2xl"
                src={pic}
        ...
        >
          ...
          >
            ...
            <h1 className="text-4xl font-bold leading-none sm:text-3xl text-white mb-14">
              <span className="">Easy & Quick</span> Way To{" "}
              Listen podcast
            </h1>
      ...
      <section className="bg-[#171717] dark:text-gray-100  md:px-20 px-5">
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          ...
          >
            <h1 className="text-lg font-semibold pb-2 text-red-800">WHY CHOOSE US</h1>
