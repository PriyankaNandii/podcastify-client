          ...
          <div className="grid grid-cols-1 gap-12 mt-14 lg:grid-cols-2 md:px-20 px-5">
            ...
            <div className="p-4 py-6 rounded-lg bg-black dark:bg-gray-800 md:p-8">
              <form>
                ...
                <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-800 rounded-lg hover:bg-red-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                  Send message
                </button>
              </form>
            </div>
