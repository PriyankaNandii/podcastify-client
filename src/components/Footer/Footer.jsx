...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-950 dark:bg-gray-900">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0 text-center lg:text-left">
            <img
              src={logo}
              alt="Podcast Logo"
              className="mx-auto lg:mx-0 h-12 w-auto object-contain" // Adjust size and centering
            />
            <p className="py-8 text-sm text-gray-500 lg:max-w-xs">
              Join us as we explore the world of podcasts! Don’t hesitate to
              reach out and let’s embark on this auditory adventure together!
            </p>
          </div>
          {/*End Col*/}
          ...
          {/*End Col*/}
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg text-gray-400 font-medium mb-7">Features</h4>
            <ul className="text-sm transition-all duration-500">
              <li className="mb-6">
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  Live Stream
          ...
          {/*End Col*/}
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg text-gray-400 font-medium mb-7">Explore</h4>
            <ul className="text-sm transition-all duration-500">
              <li className="mb-6">
                <a href="#" className="text-gray-600 hover:text-gray-900">
                  Trending Contents
          ...
          {/*End Col*/}
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg text-gray-400 font-medium mb-7">Contact</h4>
            <p className="text-sm text-gray-500 leading-6 mb-7">
              We’d love to hear from you. Reach out with any queries!
            </p>
            <a
              href="#"
              className="flex items-center justify-center gap-2 border border-red-600 rounded-full py-3 px-6 w-fit lg:mx-0 text-sm text-red-600 font-semibold transition-all duration-500 hover:bg-gray-500 hover:text-black"
            >
              Contact Us
              <svg
                width={15}
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="https://pagedone.io/">Podcastify</a> 2024, All rights
              reserved.
            </span>
